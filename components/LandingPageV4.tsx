...
.nav-logo{display:inline-flex;align-items:baseline;gap:0;color:var(--text);letter-spacing:-0.02em;font-size:18px;font-weight:700;text-decoration:none;line-height:1;}
.nav-logo .caret::after{font-size:18px;font-weight:700;margin-left:1px}
...
.footer-logo{display:inline-flex;align-items:baseline;gap:0;color:var(--text);font-size:14px;font-weight:700;letter-spacing:-0.02em;line-height:1;}
.footer-logo .caret::after{font-size:14px;font-weight:700;margin-left:1px}
...
<header class="nav" id="nav">
  <div class="nav-inner">
    <a href="#top" class="nav-logo" aria-label="Darko">Darko<span class="caret"></span></a>
    <nav class="nav-links">
